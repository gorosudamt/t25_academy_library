...
public class BookController {
    ...
    public String add( @ModelAttribute BookMstDto bookMstDto,BindingResult result,Model model) {
    ...
    // //
    // ra.addFlashAttribute("org.springframework.validation.BindingResult.bookDto",
    // result);
